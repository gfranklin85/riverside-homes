...
export default function ExchangeSection() {
  return (
    <section className="py-16 sm:py-24 bg-white dark:bg-background-dark" id="exchange">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-primary/5 dark:bg-primary/10 rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 lg:p-16 border border-primary/10 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white mb-4 sm:mb-6">
                Introducing the Exchange
              </h2>
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 mb-6 sm:mb-10 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/exchange" className="bg-primary hover:bg-primary/90 text-white font-bold py-3 px-6 sm:py-4 sm:px-8 rounded-xl flex items-center gap-2 shadow-lg shadow-primary/25 transition-all text-sm sm:text-base">
                  <span className="material-symbols-outlined filled-icon">
                    analytics
                  </span>
                  Browse the Exchange
                </Link>
                <Link href="/post" className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-bold py-3 px-6 sm:py-4 sm:px-8 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-sm sm:text-base">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-6">
                <div className="bg-white dark:bg-slate-800 p-5 sm:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:border-primary/30 transition-all group">
